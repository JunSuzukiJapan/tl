fn main() {
    ...
    let duration_src = tl_lang::compiler::codegen::builtin_types::assets::BuiltinAssets::get_source("non_generic/duration.tl");
    let builtins = tl_lang::compiler::parser::parse_from_source(&duration_src).unwrap();
