...
pub fn register_tensor_types(manager: &mut TypeManager) {
    ...
    tensor.register_evaluated_instance_method("print_1", tensor_misc::compile_print_n, vec![], Type::Void);
    tensor.register_evaluated_instance_method("print_2", tensor_misc::compile_print_n, vec![], Type::Void);
    tensor.register_evaluated_instance_method("print_3", tensor_misc::compile_print_n, vec![], Type::Void);
