# Dokumentacja TL (Polski)

## Koncepcje

- [Programowanie logiczne w TensorLanguage (TL)](logic_programming.md)
...
- [Referencja API](reference/functions_and_types.md)
- [Specyfikacja języka](reference/language_spec.md)
- [Przegląd biblioteki standardowej](reference/standard_library.md)
