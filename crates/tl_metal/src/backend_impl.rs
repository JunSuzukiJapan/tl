...
impl MetalTensor {
    ...
    pub fn where_cond(condition: &Self, x: &Self, y: &Self) -> Self { MetalTensor::where_cond_impl(condition, x, y) }
    
    // ========== 深層学習演算 ==========
    pub fn conv2d(&self, weight: &Self, stride: (usize, usize), padding: (usize, usize)) -> Self {
    ...
    pub fn layer_norm(&self, gamma: &Self, beta: &Self, eps: f32) -> Self {
    ...
    pub fn avg_pool2d(&self, kernel_size: (usize, usize), stride: (usize, usize)) -> Self {
