...
impl IDevice for CpuDevice {
    ...
    #[inline] fn tensor_scale(&self, a: *mut c_void, s: f32) -> *mut c_void { v(ffi::tl_cpu_tensor_scale(t(a), s as f64)) }
    ...
    #[inline] fn tensor_rope_new_cos(&self, dim: usize, seq_len: usize, base: f32) -> *mut c_void { v(ffi::tl_cpu_tensor_rope_new_cos(seq_len, dim, base)) }
    #[inline] fn tensor_rope_new_sin(&self, dim: usize, seq_len: usize, base: f32) -> *mut c_void { v(ffi::tl_cpu_tensor_rope_new_sin(seq_len, dim, base)) }
